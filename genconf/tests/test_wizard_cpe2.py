...
class GetProjectTest(TestCase):
    ...
    def test_get_project(self):
        ...
        project = self.wizard.get_project(self.project_instance, data)
        # Expected structure
...
class SaveTest(TestCase):
    ...
    def test_save(self):
        ...
        self.wizard.save_project(project, data)
